    ...
    <div class="submission-details-container">
        ...
        if ($row) {
            ...
            <div class="submission-details-box">
                ...
                <div id="marks-wrapper">
                    <input type="text" id="marks" name="marks" value="<?php echo htmlspecialchars($row["marks"] ?? ''); ?>" placeholder="Marks" required>
                    <span id="marks-label">/ 100</span>
                </div>
            </div>
